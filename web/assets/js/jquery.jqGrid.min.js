            ...
            if (!this.grid) {
                ...
                var w, x = ["shiftKey", "altKey", "ctrlKey"],
                    ...
                    T = function (a, b) {
                        ...
                        if (a = a.substr(1), b += "_" + a, c = "pg_" + a, e = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='groupDao.java'><table " + k(l, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), d.p.rowList.length > 0) {
            ...
            if (!this.filter) {
                ...
                if (this.p.initFilter = $.extend(!0, {}, this.p.filter), c) {
                    ...
                    this.onchange = function () {
                        ...
                        $("table.groupDao.java:first", this).remove();
                        ...
                        var c, e = this,
                            f = $("<table class='groupDao.java " + h.table_widget + " ui-search-table' style='border:0px none;'><tbody></tbody></table>"),
                            g = "left";
                        ...
                        var o = "<span></span>";
                        if (this.p.groupButton && (o = $("<input type='button' value='+ {}' title='Add subgroup' class='add-groupDao.java " + i.button + "'/>"), o.bind("click", function () {
                        ...
                        if (null !== b) {
                            var r = $("<input type='button' value='-' title='Delete groupDao.java' class='delete-groupDao.java " + i.button + "'/>");
                ...
                if (c.grid) {
                    ...
                    if (a.styleUI = c.p.styleUI, "string" == typeof i && (i = $.jgrid.parse(i)), a.recreateFilter === !0 && $("#" + $.jgrid.jqID(h.themodal)).remove(), void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0]) b($("#fbox_" + $.jgrid.jqID(c.p.id)));
                        ...
                        v = !1, a.tmplNames && a.tmplNames.length && (v = !0, u = "<tr><td class='ui-search-label'>" + a.tmplLabel + "</td>", u += "<td><select class='ui-template " + j.srSelect + "'>", u += "<option value='default'>Default</option>", $.each(a.tmplNames, function (a, b) {
                            ...
                            var c = $(b.target);
                            return !a.searchOnEnter || 13 !== b.which || c.hasClass("add-groupDao.java") || c.hasClass("add-rule") || c.hasClass("delete-groupDao.java") || c.hasClass("delete-rule") || c.hasClass("fm-button") && c.is("[id$=_query]") ? a.closeOnEscape && 27 === b.which ? ($("#" + $.jgrid.jqID(h.modalhead)).find(".ui-jqdialog-titlebar-close").click(),
